...
No GPU Acceleration (Metal/CUDA unavailable)

Utilized llama.cpp for CPU-optimized inference with AVX instruction sets.

Memory

8GB Total RAM (Shared with OS)

Implemented Quantization (q4_k_m) to compress the 3.8B parameter model to ~2.4GB RAM usage.

Latency

Slow Inference (2-3 tokens/sec)

Engineered a "Thinking" UI loop to manage user expectations and reduce perceived latency.
